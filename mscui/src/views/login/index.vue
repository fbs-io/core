...
<style scoped>
	...
	.login__bottom {left:0px;right: 0px;bottom: 0px;z-index: 3;margin: auto;padding: 40px;}
	...
	.login-header .logo {display: flex; margin: auto;}
	.login-header .logo img {width: 60px;height: 40px;vertical-align: bottom;margin: auto;}
	.login-header .logo label {font-size: 26px;font-weight: bold;margin: auto;}
